...
Download-File "https://us.download.nvidia.com/GFE/GFEClient/3.18.0.94/GeForce_Experience_v3.18.0.94.exe" "$WorkDir\GFE.exe" "GeForce Experience" "$WorkDir\GFE.exe" "GeForce Experience"
