...
Download-File "https://us.download.nvidia.com/GFE/GFEClient/3.13.0.85/GeForce_Experience_Beta_v3.13.0.85.exe" "$WorkDir\GFE.exe" "GeForce Experience" "$WorkDir\GFE.exe" "GeForce Experience" "$WorkDir\GFE.exe" "GeForce Experience"
